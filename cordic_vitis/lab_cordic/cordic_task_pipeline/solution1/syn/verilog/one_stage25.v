...
reg   [9:0] tmp_V_92_reg_147;
reg    ap_block_state1;
reg   [9:0] tmp_V_93_reg_153;
reg   [9:0] tmp_V_94_reg_159;
wire  signed [9:0] r_V_fu_89_p1;
reg  signed [9:0] r_V_reg_165;
wire  signed [9:0] r_V_10_fu_103_p1;
reg  signed [9:0] r_V_10_reg_171;
wire   [9:0] c_V_fu_115_p2;
reg    ap_block_state2;
wire   [9:0] c_V_10_fu_131_p2;
wire   [9:0] s_V_fu_120_p2;
wire   [9:0] s_V_10_fu_136_p2;
wire   [9:0] t_V_fu_125_p2;
wire   [9:0] t_V_4_fu_141_p2;
wire   [4:0] trunc_ln_fu_79_p4;
wire   [4:0] trunc_ln1333_s_fu_93_p4;
reg   [1:0] ap_NS_fsm;
...
assign c_V_10_fu_131_p2 = ($signed(tmp_V_92_reg_147) + $signed(r_V_10_reg_171));

assign c_V_fu_115_p2 = ($signed(tmp_V_92_reg_147) - $signed(r_V_10_reg_171));

assign r_V_10_fu_103_p1 = $signed(trunc_ln1333_s_fu_93_p4);

assign r_V_fu_89_p1 = $signed(trunc_ln_fu_79_p4);

assign s_V_10_fu_136_p2 = ($signed(tmp_V_93_reg_153) - $signed(r_V_reg_165));

assign s_V_fu_120_p2 = ($signed(tmp_V_93_reg_153) + $signed(r_V_reg_165));

assign start_out = real_start;

assign t_V_4_fu_141_p2 = (tmp_V_94_reg_159 + 10'd15);

assign t_V_fu_125_p2 = ($signed(tmp_V_94_reg_159) + $signed(10'd1009));

assign trunc_ln1333_s_fu_93_p4 = {{s_current_sin_V_V_dout[9:5]}};

assign trunc_ln_fu_79_p4 = {{s_current_cos_V_V_dout[9:5]}};

endmodule //one_stage25
