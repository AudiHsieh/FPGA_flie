...
const sc_logic one_stage24::ap_const_logic_1 = sc_dt::Log_1;
const sc_logic one_stage24::ap_const_logic_0 = sc_dt::Log_0;
const sc_lv<2> one_stage24::ap_ST_fsm_state1 = "1";
const sc_lv<2> one_stage24::ap_ST_fsm_state2 = "10";
const sc_lv<32> one_stage24::ap_const_lv32_0 = "00000000000000000000000000000000";
const sc_lv<32> one_stage24::ap_const_lv32_1 = "1";
const sc_lv<1> one_stage24::ap_const_lv1_0 = "0";
const sc_lv<1> one_stage24::ap_const_lv1_1 = "1";
const sc_lv<32> one_stage24::ap_const_lv32_4 = "100";
const sc_lv<32> one_stage24::ap_const_lv32_9 = "1001";
const sc_lv<10> one_stage24::ap_const_lv10_3E1 = "1111100001";
const sc_lv<10> one_stage24::ap_const_lv10_1F = "11111";
const bool one_stage24::ap_const_boolean_1 = true;

one_stage24::one_stage24(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    SC_METHOD(thread_c_V_11_fu_131_p2);
    sensitive << ( tmp_V_102_reg_147 );
    sensitive << ( r_V_11_reg_171 );
    ...
    SC_METHOD(thread_r_V_11_fu_103_p1);
    ...
    SC_METHOD(thread_s_V_11_fu_136_p2);
    sensitive << ( tmp_V_103_reg_153 );
    ...
    SC_METHOD(thread_t_V_5_fu_141_p2);
    sensitive << ( tmp_V_104_reg_159 );
    ...
    apTFilenSS << "one_stage24_sc_trace_" << apTFileNum ++;
    ...
    sc_trace(mVcdFile, tmp_V_102_reg_147, "tmp_V_102_reg_147");
    sc_trace(mVcdFile, ap_block_state1, "ap_block_state1");
    sc_trace(mVcdFile, tmp_V_103_reg_153, "tmp_V_103_reg_153");
    sc_trace(mVcdFile, tmp_V_104_reg_159, "tmp_V_104_reg_159");
    sc_trace(mVcdFile, r_V_fu_89_p1, "r_V_fu_89_p1");
    sc_trace(mVcdFile, r_V_reg_165, "r_V_reg_165");
    sc_trace(mVcdFile, r_V_11_fu_103_p1, "r_V_11_fu_103_p1");
    sc_trace(mVcdFile, r_V_11_reg_171, "r_V_11_reg_171");
    sc_trace(mVcdFile, c_V_fu_115_p2, "c_V_fu_115_p2");
    sc_trace(mVcdFile, ap_block_state2, "ap_block_state2");
    sc_trace(mVcdFile, c_V_11_fu_131_p2, "c_V_11_fu_131_p2");
    sc_trace(mVcdFile, s_V_fu_120_p2, "s_V_fu_120_p2");
    sc_trace(mVcdFile, s_V_11_fu_136_p2, "s_V_11_fu_136_p2");
    sc_trace(mVcdFile, t_V_fu_125_p2, "t_V_fu_125_p2");
    sc_trace(mVcdFile, t_V_5_fu_141_p2, "t_V_5_fu_141_p2");
...
one_stage24::~one_stage24() {
    if (mVcdFile) 
        sc_close_vcd_trace_file(mVcdFile);

}

void one_stage24::thread_ap_clk_no_reset_() {
  ...
  esl_seteq<1,1,1>(ap_const_logic_0, s_output_theta_V_V_full_n.read()))))) {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && !(esl_seteq<1,1,1>(ap_const_logic_0, real_start.read()) || esl_seteq<1,1,1>(ap_done_reg.read(), ap_const_logic_1) || esl_seteq<1,1,1>(ap_const_logic_0, s_current_cos_V_V_empty_n.read()) || esl_seteq<1,1,1>(ap_const_logic_0, s_current_sin_V_V_empty_n.read()) || esl_seteq<1,1,1>(ap_const_logic_0, s_current_theta_V_V_empty_n.read())))) {
        r_V_11_reg_171 = r_V_11_fu_103_p1.read();
        r_V_reg_165 = r_V_fu_89_p1.read();
        tmp_V_102_reg_147 = s_current_cos_V_V_dout.read();
        tmp_V_103_reg_153 = s_current_sin_V_V_dout.read();
        tmp_V_104_reg_159 = s_current_theta_V_V_dout.read();
        tmp_reg_177 = s_current_theta_V_V_dout.read().range(9, 9);
    }
}

void one_stage24::thread_ap_CS_fsm_state1() {
    ap_CS_fsm_state1 = ap_CS_fsm.read()[0];
}

void one_stage24::thread_ap_CS_fsm_state2() {
    ap_CS_fsm_state2 = ap_CS_fsm.read()[1];
}

void one_stage24::thread_ap_block_state1() {
    ap_block_state1 = (esl_seteq<1,1,1>(ap_const_logic_0, real_start.read()) || esl_seteq<1,1,1>(ap_done_reg.read(), ap_const_logic_1) || esl_seteq<1,1,1>(ap_const_logic_0, s_current_cos_V_V_empty_n.read()) || esl_seteq<1,1,1>(ap_const_logic_0, s_current_sin_V_V_empty_n.read()) || esl_seteq<1,1,1>(ap_const_logic_0, s_current_theta_V_V_empty_n.read()));
}

void one_stage24::thread_ap_block_state2() {
...
void one_stage24::thread_ap_condition_122() {
...
void one_stage24::thread_ap_done() {
...
void one_stage24::thread_ap_idle() {
...
void one_stage24::thread_ap_ready() {
    ap_ready = internal_ap_ready.read();
}

void one_stage24::thread_c_V_11_fu_131_p2() {
    c_V_11_fu_131_p2 = (!tmp_V_102_reg_147.read().is_01() || !r_V_11_reg_171.read().is_01())? sc_lv<10>(): (sc_biguint<10>(tmp_V_102_reg_147.read()) + sc_bigint<10>(r_V_11_reg_171.read()));
}

void one_stage24::thread_c_V_fu_115_p2() {
    c_V_fu_115_p2 = (!tmp_V_102_reg_147.read().is_01() || !r_V_11_reg_171.read().is_01())? sc_lv<10>(): (sc_biguint<10>(tmp_V_102_reg_147.read()) - sc_bigint<10>(r_V_11_reg_171.read()));
}

void one_stage24::thread_internal_ap_ready() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && 
         !((esl_seteq<1,1,1>(tmp_reg_177.read(), ap_const_lv1_0) && 
  esl_seteq<1,1,1>(ap_const_logic_0, s_output_cos_V_V_full_n.read())) || (esl_seteq<1,1,1>(tmp_reg_177.read(), ap_const_lv1_0) && 
  esl_seteq<1,1,1>(ap_const_logic_0, s_output_sin_V_V_full_n.read())) || (esl_seteq<1,1,1>(tmp_reg_177.read(), ap_const_lv1_0) && 
...
void one_stage24::thread_r_V_11_fu_103_p1() {
    r_V_11_fu_103_p1 = esl_sext<10,6>(trunc_ln1333_s_fu_93_p4.read());
}

void one_stage24::thread_r_V_fu_89_p1() {
    r_V_fu_89_p1 = esl_sext<10,6>(trunc_ln_fu_79_p4.read());
}

void one_stage24::thread_real_start() {
...
void one_stage24::thread_s_V_11_fu_136_p2() {
    s_V_11_fu_136_p2 = (!tmp_V_103_reg_153.read().is_01() || !r_V_reg_165.read().is_01())? sc_lv<10>(): (sc_biguint<10>(tmp_V_103_reg_153.read()) - sc_bigint<10>(r_V_reg_165.read()));
}

void one_stage24::thread_s_V_fu_120_p2() {
    s_V_fu_120_p2 = (!tmp_V_103_reg_153.read().is_01() || !r_V_reg_165.read().is_01())? sc_lv<10>(): (sc_biguint<10>(tmp_V_103_reg_153.read()) + sc_bigint<10>(r_V_reg_165.read()));
}

void one_stage24::thread_s_current_cos_V_V_blk_n() {
...
void one_stage24::thread_s_current_cos_V_V_read() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
...
void one_stage24::thread_s_current_sin_V_V_blk_n() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
         !(esl_seteq<1,1,1>(ap_const_logic_0, real_start.read()) || esl_seteq<1,1,1>(ap_done_reg.read(), ap_const_logic_1)))) {
...
void one_stage24::thread_s_current_sin_V_V_read() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
         !(esl_seteq<1,1,1>(ap_const_logic_0, real_start.read()) || esl_seteq<1,1,1>(ap_done_reg.read(), ap_const_logic_1) || esl_seteq<1,1,1>(ap_const_logic_0, s_current_cos_V_V_empty_n.read()) || esl_seteq<1,1,1>(ap_const_logic_0, s_current_sin_V_V_empty_n.read()) || esl_seteq<1,1,1>(ap_const_logic_0, s_current_theta_V_V_empty_n.read())))) {
...
void one_stage24::thread_s_current_theta_V_V_blk_n() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
         !(esl_seteq<1,1,1>(ap_const_logic_0, real_start.read()) || esl_seteq<1,1,1>(ap_done_reg.read(), ap_const_logic_1)))) {
...
void one_stage24::thread_s_current_theta_V_V_read() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
         !(esl_seteq<1,1,1>(ap_const_logic_0, real_start.read()) || esl_seteq<1,1,1>(ap_done_reg.read(), ap_const_logic_1) || esl_seteq<1,1,1>(ap_const_logic_0, s_current_cos_V_V_empty_n.read()) || esl_seteq<1,1,1>(ap_const_logic_0, s_current_sin_V_V_empty_n.read()) || esl_seteq<1,1,1>(ap_const_logic_0, s_current_theta_V_V_empty_n.read())))) {
...
void one_stage24::thread_s_output_cos_V_V_blk_n() {
    if (((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && 
          esl_seteq<1,1,1>(tmp_reg_177.read(), ap_const_lv1_0)) || 
...
void one_stage24::thread_s_output_cos_V_V_write() {
    if (((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && 
          esl_seteq<1,1,1>(tmp_reg_177.read(), ap_const_lv1_0) && 
          !((esl_seteq<1,1,1>(tmp_reg_177.read(), ap_const_lv1_0) && 
  esl_seteq<1,1,1>(ap_const_logic_0, s_output_cos_V_V_full_n.read())) || (esl_seteq<1,1,1>(tmp_reg_177.read(), ap_const_lv1_0) && 
...
void one_stage24::thread_s_output_sin_V_V_blk_n() {
    if (((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && 
          esl_seteq<1,1,1>(tmp_reg_177.read(), ap_const_lv1_0)) || 
         (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && 
          esl_seteq<1,1,1>(tmp_reg_177.read(), ap_const_lv1_1)))) {
...
void one_stage24::thread_s_output_sin_V_V_din() {
    if (esl_seteq<1,1,1>(ap_condition_122.read(), ap_const_boolean_1)) {
        if (esl_seteq<1,1,1>(tmp_reg_177.read(), ap_const_lv1_1)) {
            s_output_sin_V_V_din = s_V_11_fu_136_p2.read();
        } else if (esl_seteq<1,1,1>(tmp_reg_177.read(), ap_const_lv1_0)) {
...
void one_stage24::thread_s_output_sin_V_V_write() {
    if (((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && 
          esl_seteq<1,1,1>(tmp_reg_177.read(), ap_const_lv1_0) && 
          !((esl_seteq<1,1,1>(tmp_reg_177.read(), ap_const_lv1_0) && 
  esl_seteq<1,1,1>(ap_const_logic_0, s_output_cos_V_V_full_n.read())) || (esl_seteq<1,1,1>(tmp_reg_177.read(), ap_const_lv1_0) && 
...
void one_stage24::thread_s_output_theta_V_V_blk_n() {
    if (((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && 
          esl_seteq<1,1,1>(tmp_reg_177.read(), ap_const_lv1_0)) || 
         (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && 
          esl_seteq<1,1,1>(tmp_reg_177.read(), ap_const_lv1_1)))) {
...
void one_stage24::thread_s_output_theta_V_V_din() {
    if (esl_seteq<1,1,1>(ap_condition_122.read(), ap_const_boolean_1)) {
        if (esl_seteq<1,1,1>(tmp_reg_177.read(), ap_const_lv1_1)) {
            s_output_theta_V_V_din = t_V_5_fu_141_p2.read();
        } else if (esl_seteq<1,1,1>(tmp_reg_177.read(), ap_const_lv1_0)) {
...
void one_stage24::thread_s_output_theta_V_V_write() {
    if (((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && 
          esl_seteq<1,1,1>(tmp_reg_177.read(), ap_const_lv1_0) && 
          !((esl_seteq<1,1,1>(tmp_reg_177.read(), ap_const_lv1_0) && 
  esl_seteq<1,1,1>(ap_const_logic_0, s_output_cos_V_V_full_n.read())) || (esl_seteq<1,1,1>(tmp_reg_177.read(), ap_const_lv1_0) && 
...
void one_stage24::thread_start_out() {
    start_out = real_start.read();
}

void one_stage24::thread_start_write() {
...
void one_stage24::thread_t_V_5_fu_141_p2() {
    t_V_5_fu_141_p2 = (!tmp_V_104_reg_159.read().is_01() || !ap_const_lv10_1F.is_01())? sc_lv<10>(): (sc_biguint<10>(tmp_V_104_reg_159.read()) + sc_biguint<10>(ap_const_lv10_1F));
}

void one_stage24::thread_t_V_fu_125_p2() {
    t_V_fu_125_p2 = (!tmp_V_104_reg_159.read().is_01() || !ap_const_lv10_3E1.is_01())? sc_lv<10>(): (sc_biguint<10>(tmp_V_104_reg_159.read()) + sc_bigint<10>(ap_const_lv10_3E1));
}

void one_stage24::thread_trunc_ln1333_s_fu_93_p4() {
    trunc_ln1333_s_fu_93_p4 = s_current_sin_V_V_dout.read().range(9, 4);
}

void one_stage24::thread_trunc_ln_fu_79_p4() {
    trunc_ln_fu_79_p4 = s_current_cos_V_V_dout.read().range(9, 4);
}

void one_stage24::thread_ap_NS_fsm() {
