...
reg   [0:0] tmp_2_reg_164;
reg    s_output_sin_V_V_blk_n;
reg    s_output_theta_V_V_blk_n;
reg   [9:0] tmp_V_8_reg_135;
reg    ap_block_state1;
reg   [9:0] tmp_V_9_reg_141;
reg   [9:0] tmp_V_7_reg_147;
wire   [9:0] r_V_fu_83_p3;
reg   [9:0] r_V_reg_152;
wire   [9:0] r_V_1_fu_99_p3;
reg   [9:0] r_V_1_reg_158;
wire   [9:0] c_V_fu_115_p2;
reg    ap_block_state2;
wire   [9:0] c_V_1_fu_125_p2;
wire   [9:0] s_V_fu_120_p2;
wire   [9:0] s_V_1_fu_130_p2;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if ((~(((tmp_2_reg_164 == 1'd1) & (s_output_theta_V_V_full_n == 1'b0)) | ((tmp_2_reg_164 == 1'd1) & (s_output_sin_V_V_full_n == 1'b0)) | ((tmp_2_reg_164 == 1'd1) & (s_output_cos_V_V_full_n == 1'b0)) | ((tmp_2_reg_164 == 1'd0) & (s_output_theta_V_V_full_n == 1'b0)) | ((tmp_2_reg_164 == 1'd0) & (s_output_sin_V_V_full_n == 1'b0)) | ((tmp_2_reg_164 == 1'd0) & (s_output_cos_V_V_full_n == 1'b0))) & (1'b1 == ap_CS_fsm_state2))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((~((real_start == 1'b0) | (s_current_theta_V_V_empty_n == 1'b0) | (s_current_sin_V_V_empty_n == 1'b0) | (s_current_cos_V_V_empty_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        ...
        tmp_2_reg_164 <= s_current_theta_V_V_dout[32'd9];
...
always @ (*) begin
    if ((~(((tmp_2_reg_164 == 1'd1) & (s_output_theta_V_V_full_n == 1'b0)) | ((tmp_2_reg_164 == 1'd1) & (s_output_sin_V_V_full_n == 1'b0)) | ((tmp_2_reg_164 == 1'd1) & (s_output_cos_V_V_full_n == 1'b0)) | ((tmp_2_reg_164 == 1'd0) & (s_output_theta_V_V_full_n == 1'b0)) | ((tmp_2_reg_164 == 1'd0) & (s_output_sin_V_V_full_n == 1'b0)) | ((tmp_2_reg_164 == 1'd0) & (s_output_cos_V_V_full_n == 1'b0))) & (1'b1 == ap_CS_fsm_state2))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if ((((tmp_2_reg_164 == 1'd1) & (1'b1 == ap_CS_fsm_state2)) | ((tmp_2_reg_164 == 1'd0) & (1'b1 == ap_CS_fsm_state2)))) begin
...
always @ (*) begin
    if ((1'b1 == ap_condition_122)) begin
        if ((tmp_2_reg_164 == 1'd1)) begin
            s_output_cos_V_V_din = c_V_1_fu_125_p2;
        end else if ((tmp_2_reg_164 == 1'd0)) begin
...
always @ (*) begin
    if (((~(((tmp_2_reg_164 == 1'd1) & (s_output_theta_V_V_full_n == 1'b0)) | ((tmp_2_reg_164 == 1'd1) & (s_output_sin_V_V_full_n == 1'b0)) | ((tmp_2_reg_164 == 1'd1) & (s_output_cos_V_V_full_n == 1'b0)) | ((tmp_2_reg_164 == 1'd0) & (s_output_theta_V_V_full_n == 1'b0)) | ((tmp_2_reg_164 == 1'd0) & (s_output_sin_V_V_full_n == 1'b0)) | ((tmp_2_reg_164 == 1'd0) & (s_output_cos_V_V_full_n == 1'b0))) & (tmp_2_reg_164 == 1'd1) & (1'b1 == ap_CS_fsm_state2)) | (~(((tmp_2_reg_164 == 1'd1) & (s_output_theta_V_V_full_n == 1'b0)) | ((tmp_2_reg_164 == 1'd1) & (s_output_sin_V_V_full_n == 1'b0)) | ((tmp_2_reg_164 == 1'd1) & (s_output_cos_V_V_full_n == 1'b0)) | ((tmp_2_reg_164 == 1'd0) & (s_output_theta_V_V_full_n == 1'b0)) | ((tmp_2_reg_164 == 1'd0) & (s_output_sin_V_V_full_n == 1'b0)) | ((tmp_2_reg_164 == 1'd0) & (s_output_cos_V_V_full_n == 1'b0))) & (tmp_2_reg_164 == 1'd0) & (1'b1 == ap_CS_fsm_state2)))) begin
...
always @ (*) begin
    ap_block_state2 = (((tmp_2_reg_164 == 1'd1) & (s_output_theta_V_V_full_n == 1'b0)) | ((tmp_2_reg_164 == 1'd1) & (s_output_sin_V_V_full_n == 1'b0)) | ((tmp_2_reg_164 == 1'd1) & (s_output_cos_V_V_full_n == 1'b0)) | ((tmp_2_reg_164 == 1'd0) & (s_output_theta_V_V_full_n == 1'b0)) | ((tmp_2_reg_164 == 1'd0) & (s_output_sin_V_V_full_n == 1'b0)) | ((tmp_2_reg_164 == 1'd0) & (s_output_cos_V_V_full_n == 1'b0)));
end

always @ (*) begin
    ap_condition_122 = (~(((tmp_2_reg_164 == 1'd1) & (s_output_theta_V_V_full_n == 1'b0)) | ((tmp_2_reg_164 == 1'd1) & (s_output_sin_V_V_full_n == 1'b0)) | ((tmp_2_reg_164 == 1'd1) & (s_output_cos_V_V_full_n == 1'b0)) | ((tmp_2_reg_164 == 1'd0) & (s_output_theta_V_V_full_n == 1'b0)) | ((tmp_2_reg_164 == 1'd0) & (s_output_sin_V_V_full_n == 1'b0)) | ((tmp_2_reg_164 == 1'd0) & (s_output_cos_V_V_full_n == 1'b0))) & (1'b1 == ap_CS_fsm_state2));
end

assign ap_ready = internal_ap_ready;

assign c_V_1_fu_125_p2 = (tmp_V_8_reg_135 + r_V_1_reg_158);

assign c_V_fu_115_p2 = (tmp_V_8_reg_135 - r_V_1_reg_158);

assign r_V_1_fu_99_p3 = ((tmp_1_fu_91_p3[0:0] === 1'b1) ? 10'd1023 : 10'd0);

assign r_V_fu_83_p3 = ((tmp_fu_75_p3[0:0] === 1'b1) ? 10'd1023 : 10'd0);

assign s_V_1_fu_130_p2 = (tmp_V_9_reg_141 - r_V_reg_152);

assign s_V_fu_120_p2 = (tmp_V_9_reg_141 + r_V_reg_152);

assign s_output_theta_V_V_din = tmp_V_7_reg_147;

assign start_out = real_start;

assign tmp_1_fu_91_p3 = s_current_sin_V_V_dout[32'd9];

assign tmp_fu_75_p3 = s_current_cos_V_V_dout[32'd9];

endmodule //one_stage34
