...
entity histogram_histogram_map_Pipeline_VITIS_LOOP_10_2 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of histogram_histogram_map_Pipeline_VITIS_LOOP_10_2 is 
...
attribute shreg_extract : string;
    ...
    signal old_3_reg_246 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal i_1_fu_50 : STD_LOGIC_VECTOR (9 downto 0);
    signal ap_sig_allocacmp_i : STD_LOGIC_VECTOR (9 downto 0);
    signal add_ln10_fu_140_p2 : STD_LOGIC_VECTOR (9 downto 0);
    ...
    signal trunc_ln12_fu_146_p1 : STD_LOGIC_VECTOR (8 downto 0);
...
begin
    ...
    acc_1_fu_198_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_acc_load_2) + unsigned(ap_const_lv32_1));
    acc_out <= acc_fu_54;
    ...
    add_ln10_fu_140_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i) + unsigned(ap_const_lv10_1));
    ...
    ap_sig_allocacmp_acc_load_1_assign_proc : process(ap_enable_reg_pp0_iter3, hist_q1, icmp_ln13_reg_253, ap_block_pp0_stage0, acc_fu_54, acc_1_fu_198_p2)
    begin
    ...
    ap_sig_allocacmp_acc_load_2_assign_proc : process(ap_enable_reg_pp0_iter3, hist_q1, icmp_ln13_reg_253, ap_block_pp0_stage0, acc_fu_54)
    begin
        if (((icmp_ln13_reg_253 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter3 = ap_const_logic_1))) then 
            ap_sig_allocacmp_acc_load_2 <= hist_q1;
        else 
    ...
    hist_address0 <= zext_ln16_fu_177_p1(10 - 1 downto 0);
    hist_address1 <= zext_ln17_fu_182_p1(10 - 1 downto 0);
    ...
    hist_d0 <= ap_sig_allocacmp_acc_load_1;
    ...
    icmp_ln10_fu_134_p2 <= "1" when (ap_sig_allocacmp_i = ap_const_lv10_200) else "0";
    icmp_ln13_fu_168_p2 <= "1" when (old_1_fu_46 = old_3_reg_246) else "0";
    inputA_address0 <= zext_ln12_fu_150_p1(9 - 1 downto 0);
    ...
    old_1_out <= old_1_fu_46(10 - 1 downto 0);
    ...
    trunc_ln12_fu_146_p1 <= ap_sig_allocacmp_i(9 - 1 downto 0);
    ...
    zext_ln17_fu_182_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(old_3_reg_246),64));
end behav;
